...
import com.example.petShop.petShop.dominio.pessoa.repository.IPessoaRepository;
...
public class PessoaController {
    ...
    @GetMapping
    public ResponseEntity<List<Pessoa>> findAll(@RequestParam(value = "pagina", defaultValue = "1")Integer pagina, @RequestParam(value = "tamanho", defaultValue = "10")Integer tamanho){
    ...
    public ResponseEntity<Pessoa> save(@RequestBody Pessoa pessoa){
        var pessoasSaved = repo.save(pessoa);

        return ResponseEntity.status(HttpStatus.CREATED).body(pessoasSaved);
    }
